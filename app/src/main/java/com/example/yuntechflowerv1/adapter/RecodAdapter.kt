...
import com.example.yuntechflowerv1.databinding.RecognitionItemsBinding
...
class RecognitionAdapter(private val ctx: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecognitionViewHolder {
        ...
        val binding = RecognitionItemsBinding.inflate(inflater, parent, false)
...
class RecognitionViewHolder(private val binding: RecognitionItemsBinding) :
